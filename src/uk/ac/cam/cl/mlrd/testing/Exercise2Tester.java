...
import uk.ac.cam.cl.ac2154.exercises.Exercise1;
...
public class Exercise2Tester {
	...
	public static void main(String[] args) throws IOException {
		...
		/* //Used to measure simple classifier on training set.
		Map<Path, Sentiment> simplePredictions = implementation1.simpleClassifier(split.trainingSet.keySet(),
				lexiconFile);
		System.out.println("Simple classifier predictions (training set):");
		System.out.println(simplePredictions);
		System.out.println();

		double simpleAccuracy = implementation1.calculateAccuracy(split.trainingSet, simplePredictions);
		System.out.println("Simple classifier accuracy (training set):");
		System.out.println(simpleAccuracy);
		System.out.println(); */
